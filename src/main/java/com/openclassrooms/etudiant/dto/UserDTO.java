...
public class UserDTO {
    ...
    @Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&@$!%*?&.-_])[A-Za-z\\d@$!%*?&@$!%*?&.-_]+$", message = "Password must contain at least one lowercase letter, one uppercase letter, one digit, and one special character")
